...
class TMCFlagGroup:
    ...
    UNUSED_ROYAL_CRYPT_DUNGEON_ITEMS = "Unused Royal Crypt Dungeon Items"
    UNUSED_DUNGEON_2_DUNGEON_ITEMS = "Unused Dungeon 2 Dungeon Items"
    UNUSED_DUNGEON_1_WARPS = "Unused Dungeon 1 Warps"
    DEEPWOOD_SHRINE_WARPS = "Deepwood Shrine Warps"
    CAVE_OF_FLAMES_WARPS = "Cave of Flames Warps"
    FORTRESS_OF_WINDS_WARPS = "Fortress of Winds Warps"
    TEMPLE_OF_DROPLETS_WARPS = "Temple of Droplets Warps"
    PALACE_OF_WINDS_WARPS = "Palace of Winds Warps"
    DARK_HYRULE_CASTLE_WARPS = "Dark Hyrule Castle Warps"
    UNUSED_ROYAL_CRYPT_WARPS = "Royal Crypt Warps"
    UNUSED_DUNGEON_2_WARPS = "Unused Dungeon 2 Warps"
...
class TMCEvent:
    ...
    TOD_LEFTPATH_B2_GATE1_SWITCH = "TOD: Press the switch to activate the Gate on the Left Path B2 after falling down the waterfall"

...
all_locations: typing.List[LocationData] = [
    ...
    #region Crenel
    LocationData(
        6029153, TMCLocation.CRENEL_BASE_ENTRANCE_VINE, TMCRegion.TRILBY_HIGHLANDS, Items.RUPEES_20,
        (0x0FAACF, None), (0x2CC5, 0x02), 0x0406, pools={POOL_RUPEE}),
    LocationData(
        6029154, TMCLocation.CRENEL_BASE_FAIRY_CAVE_ITEM1, TMCRegion.CRENEL_BASE, Items.RUPEES_5,
        (0x0FB3F3, None), (0x2D24, 0x08), 0x0926, pools={POOL_RUPEE}),
    LocationData(
        6029155, TMCLocation.CRENEL_BASE_FAIRY_CAVE_ITEM2, TMCRegion.CRENEL_BASE, Items.RUPEES_5,
        (0x0FB403, None), (0x2D24, 0x10), 0x0926, pools={POOL_RUPEE}),
    LocationData(
        6029156, TMCLocation.CRENEL_BASE_FAIRY_CAVE_ITEM3, TMCRegion.CRENEL_BASE, Items.RUPEES_5,
        (0x0FB413, None), (0x2D24, 0x20), 0x0926, pools={POOL_RUPEE}),
    LocationData(
        6029157, TMCLocation.CRENEL_BASE_GREEN_WATER_FUSION_CHEST, TMCRegion.CRENEL_BASE, Items.KINSTONE,
        (0x0FE06E, None), (0x2D10, 0x80), 0x0112),
    LocationData(
        6029158, TMCLocation.CRENEL_BASE_WEST_FUSION_CHEST, TMCRegion.CRENEL_BASE, Items.RUPEES_200,
        (0x0FE116, None), (0x2CD4, 0x02), 0x0406),
    LocationData(
        6029159, TMCLocation.CRENEL_BASE_WATER_CAVE_LEFT_CHEST, TMCRegion.CRENEL_BASE, Items.RUPEES_50,
        (0x0FB38A, None), (0x2D24, 0x02), 0x0826),
    LocationData(
        6029160, TMCLocation.CRENEL_BASE_WATER_CAVE_RIGHT_CHEST, TMCRegion.CRENEL_BASE, Items.KINSTONE,
        (0x0FB392, None), (0x2D24, 0x04), 0x0826),
    LocationData(
        6029161, TMCLocation.CRENEL_BASE_WATER_CAVE_HP, TMCRegion.CRENEL_BASE, Items.HEART_PIECE,
        (0x0FB32B, None), (0x2D24, 0x01), 0x0826, pools={POOL_HP}),
    LocationData(
        6029162, TMCLocation.CRENEL_BASE_MINISH_VINE_HOLE_CHEST, TMCRegion.CRENEL_BASE, Items.KINSTONE,
        (0x0DB376, None), (0x2D28, 0x01), 0x0035),
    LocationData(
        6029163, TMCLocation.CRENEL_BASE_MINISH_CRACK_CHEST, TMCRegion.CRENEL_BASE, Items.KINSTONE,
    ...
    LocationData(
        6029186, TMCLocation.CRENEL_UPPER_BLOCK_CHEST, TMCRegion.MELARI, Items.KINSTONE,
    ...
    LocationData(
        6029188, TMCLocation.CRENEL_MELARI_MIDDLE_LEFT_DIG, TMCRegion.MELARI, Items.KINSTONE,
        (0x0DC8C3, None), (0x2CF3, 0x02), 0x0010, pools={POOL_DIG}),
    LocationData(
        6029189, TMCLocation.CRENEL_MELARI_TOP_MIDDLE_DIG, TMCRegion.MELARI, Items.KINSTONE,
        (0x0DC8D3, None), (0x2CF3, 0x04), 0x0010, pools={POOL_DIG}),
    LocationData(
        6029190, TMCLocation.CRENEL_MELARI_TOP_LEFT_DIG, TMCRegion.MELARI, Items.RUPEES_20,
        (0x0DC8E3, None), (0x2CF3, 0x08), 0x0010, pools={POOL_DIG}),
    LocationData(
        6029191, TMCLocation.CRENEL_MELARI_TOP_RIGHT_DIG, TMCRegion.MELARI, Items.KINSTONE,
        (0x0DC8F3, None), (0x2CF3, 0x10), 0x0010, pools={POOL_DIG}),
    LocationData(
        6029192, TMCLocation.CRENEL_MELARI_BOTTOM_RIGHT_DIG, TMCRegion.MELARI, Items.RUPEES_20,
        (0x0DC903, None), (0x2CF3, 0x20), 0x0010, pools={POOL_DIG}),
    LocationData(
        6029193, TMCLocation.CRENEL_MELARI_BOTTOM_MIDDLE_DIG, TMCRegion.MELARI, Items.RUPEES_20,
        (0x0DC913, None), (0x2CF3, 0x40), 0x0010, pools={POOL_DIG}),
    LocationData(
        6029194, TMCLocation.CRENEL_MELARI_BOTTOM_LEFT_DIG, TMCRegion.MELARI, Items.RUPEES_20,
        (0x0DC923, None), (0x2CF3, 0x80), 0x0010, pools={POOL_DIG}),
    LocationData(
        6029195, TMCLocation.CRENEL_MELARI_CENTER_DIG, TMCRegion.MELARI, Items.KINSTONE,
        (0x0DC933, None), (0x2CF4, 0x01), 0x0010, pools={POOL_DIG}),
    LocationData(
        6029196, TMCLocation.CRENEL_MELARI_NPC_COF, TMCRegion.MELARI, Items.PROGRESSIVE_SWORD,
    ...
    #region Castor Ruins
    LocationData(
        6029219, TMCLocation.RUINS_BUTTERFLY_FUSION_ITEM, TMCRegion.WIND_RUINS, Items.BOW_BUTTERFLY,
        (0x0FE12F, None), (0x2EA7, 0x08), 0x0005, pools={POOL_BUTTERFLY}),
    LocationData(
        6029220, TMCLocation.RUINS_BOMB_CAVE_CHEST, TMCRegion.WIND_RUINS, Items.KINSTONE,
        (0x0D981E, None), (0x2D22, 0x80), 0x022A),
    LocationData(
        6029221, TMCLocation.RUINS_MINISH_HOME_CHEST, TMCRegion.WIND_RUINS, Items.KINSTONE,
    ...
    LocationData(
        6029223, TMCLocation.RUINS_BEAN_STALK_FUSION_BIG_CHEST, TMCRegion.WIND_RUINS, Items.QUIVER,
        (0x0F603A, None), (0x2D0C, 0x80), 0x020D),
    LocationData(
        6029224, TMCLocation.RUINS_CRACK_FUSION_CHEST, TMCRegion.WIND_RUINS, Items.KINSTONE,
        (0x0DC602, None), (0x2CF0, 0x10), 0x0C27),
    LocationData(
        6029225, TMCLocation.RUINS_MINISH_CAVE_HP, TMCRegion.WIND_RUINS, Items.HEART_PIECE,
        (0x0DB4BF, None), (0x2D2B, 0x40), 0x0335, pools={POOL_HP}),
    LocationData(
        6029226, TMCLocation.RUINS_ARMOS_KILL_LEFT_CHEST, TMCRegion.WIND_RUINS, Items.RUPEES_50,
    ...
    LocationData(
        6029228, TMCLocation.RUINS_GOLDEN_OCTO, TMCRegion.WIND_RUINS, Items.RUPEES_100,
        (None, None), (0x2CA2, 0x02), 0x0505, pools={POOL_ENEMY}),
    LocationData(
        6029229, TMCLocation.RUINS_NEAR_FOW_FUSION_CHEST, TMCRegion.WIND_RUINS, Items.BOMB_BAG,
    ...
    LocationData(
        6029231, TMCLocation.VALLEY_GREAT_FAIRY_NPC, TMCRegion.ROYAL_VALLEY, Items.QUIVER,
    ...
    LocationData(
        6029233, TMCLocation.VALLEY_DAMPE_NPC, TMCRegion.ROYAL_VALLEY, Items.GRAVEYARD_KEY,
        (0x0096B6, None), (0x2CE9, 0x02), 0x1222),
    LocationData(
        6029234, TMCLocation.VALLEY_GRAVEYARD_BUTTERFLY_FUSION_ITEM, TMCRegion.GRAVEYARD, Items.SWIM_BUTTERFLY,
        (0x0FE14F, None), (0x2EA7, 0x20), 0x0009, pools={POOL_BUTTERFLY}),
    LocationData(
        6029235, TMCLocation.VALLEY_GRAVEYARD_LEFT_FUSION_CHEST, TMCRegion.GRAVEYARD, Items.KINSTONE,
        (0x0FE0DE, None), (0x2CD3, 0x04), 0x0009),
    LocationData(
        6029236, TMCLocation.VALLEY_GRAVEYARD_LEFT_GRAVE_HP, TMCRegion.GRAVEYARD, Items.HEART_PIECE,
        (0x0D8AE7, None), (0x2D27, 0x20), 0x0034, scoutable=True),
    LocationData(
        6029237, TMCLocation.VALLEY_GRAVEYARD_RIGHT_FUSION_CHEST, TMCRegion.GRAVEYARD, Items.KINSTONE,
    ...
    LocationData(
        6029368, TMCLocation.DROPLETS_LEFT_PATH_B1_UNDERPASS_ITEM1, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_1,
        (0x0E3F8B, None), (0x2D94, 0x20), 0x0D60, pools={POOL_RUPEE}),
    LocationData(
        6029369, TMCLocation.DROPLETS_LEFT_PATH_B1_UNDERPASS_ITEM2, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_1,
        (0x0E3F9B, None), (0x2D94, 0x40), 0x0D60, pools={POOL_RUPEE}),
    LocationData(
        6029370, TMCLocation.DROPLETS_LEFT_PATH_B1_UNDERPASS_ITEM3, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_1,
        (0x0E3FAB, None), (0x2D94, 0x80), 0x0D60, pools={POOL_RUPEE}),
    LocationData(
        6029371, TMCLocation.DROPLETS_LEFT_PATH_B1_UNDERPASS_ITEM4, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_1,
        (0x0E3FBB, None), (0x2D95, 0x01), 0x0D60, pools={POOL_RUPEE}),
    LocationData(
        6029372, TMCLocation.DROPLETS_LEFT_PATH_B1_UNDERPASS_ITEM5, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_1,
        (0x0E3FCB, None), (0x2D95, 0x02), 0x0D60, pools={POOL_RUPEE}),
    LocationData(
        6029373, TMCLocation.DROPLETS_LEFT_PATH_B1_WATERFALL_BIG_CHEST, TMCRegion.DUNGEON_TOD_MAIN, Items.DUNGEON_MAP_TOD,
        (0x0E400A, None), (0x2D8B, 0x80), 0x0D60),
    LocationData(
        6029374, TMCLocation.DROPLETS_LEFT_PATH_B1_WATERFALL_UNDERWATER1, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_5,
        (0x0E3593, None), (0x2D96, 0x20), 0x0660, pools={POOL_WATER}),
    LocationData(
        6029375, TMCLocation.DROPLETS_LEFT_PATH_B1_WATERFALL_UNDERWATER2, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_5,
        (0x0E35A3, None), (0x2D96, 0x40), 0x0660, pools={POOL_WATER}),
    LocationData(
        6029376, TMCLocation.DROPLETS_LEFT_PATH_B1_WATERFALL_UNDERWATER3, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_5,
        (0x0E35B3, None), (0x2D96, 0x80), 0x0660, pools={POOL_WATER}),
    LocationData(
        6029377, TMCLocation.DROPLETS_LEFT_PATH_B1_WATERFALL_UNDERWATER4, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_5,
        (0x0E35C3, None), (0x2D97, 0x01), 0x0660, pools={POOL_WATER}),
    LocationData(
        6029378, TMCLocation.DROPLETS_LEFT_PATH_B1_WATERFALL_UNDERWATER5, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_5,
        (0x0E35D3, None), (0x2D97, 0x02), 0x0660, pools={POOL_WATER}),
    LocationData(
        6029379, TMCLocation.DROPLETS_LEFT_PATH_B1_WATERFALL_UNDERWATER6, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_5,
        (0x0E35E3, None), (0x2D97, 0x04), 0x0660, pools={POOL_WATER}),
    LocationData(
        6029380, TMCLocation.DROPLETS_LEFT_PATH_B2_WATERFALL_UNDERWATER1, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_5,
        (0x0E58DF, None), (0x2D95, 0x80), 0x3160, pools={POOL_WATER}),
    LocationData(
        6029381, TMCLocation.DROPLETS_LEFT_PATH_B2_WATERFALL_UNDERWATER2, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_5,
        (0x0E58EF, None), (0x2D96, 0x01), 0x3160, pools={POOL_WATER}),
    LocationData(
        6029382, TMCLocation.DROPLETS_LEFT_PATH_B2_WATERFALL_UNDERWATER3, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_5,
        (0x0E58FF, None), (0x2D96, 0x02), 0x3160, pools={POOL_WATER}),
    LocationData(
        6029383, TMCLocation.DROPLETS_LEFT_PATH_B2_WATERFALL_UNDERWATER4, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_5,
        (0x0E590F, None), (0x2D96, 0x04), 0x3160, pools={POOL_WATER}),
    LocationData(
        6029384, TMCLocation.DROPLETS_LEFT_PATH_B2_WATERFALL_UNDERWATER5, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_5,
        (0x0E591F, None), (0x2D96, 0x08), 0x3160, pools={POOL_WATER}),
    LocationData(
        6029385, TMCLocation.DROPLETS_LEFT_PATH_B2_WATERFALL_UNDERWATER6, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_5,
        (0x0E592F, None), (0x2D96, 0x10), 0x3160, pools={POOL_WATER}),
    LocationData(
        6029386, TMCLocation.DROPLETS_LEFT_PATH_B2_UNDERWATER_POT, TMCRegion.DUNGEON_TOD_MAIN, Items.SMALL_KEY_TOD,
        (0x0E5BC7, None), (0x2D93, 0x04), 0x3460, pools={POOL_WATER}),
    LocationData(
        6029387, TMCLocation.DROPLETS_LEFT_PATH_B2_ICE_MADDERPILLAR_BIG_CHEST, TMCRegion.DUNGEON_TOD_MAIN, Items.DUNGEON_COMPASS_TOD,
    ...
    LocationData(
        6029389, TMCLocation.DROPLETS_LEFT_PATH_B2_ICE_PLAIN_CHEST, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_50,
        (0x0E4E16, None), (0x2D8F, 0x08), 0x2860),
    LocationData(
        6029390, TMCLocation.DROPLETS_LEFT_PATH_B2_LILYPAD_CORNER_FROZEN_CHEST, TMCRegion.DUNGEON_TOD_MAIN, Items.KINSTONE,
        (0x0E5492, None), (0x2D93, 0x40), 0x2D60),
    LocationData(
        6029391, TMCLocation.DROPLETS_RIGHT_PATH_B1_1ST_CHEST, TMCRegion.DUNGEON_TOD_MAIN, Items.KINSTONE,
        (0x0E3A2A, None), (0x2D8B, 0x01), 0x0960),
    LocationData(
        6029392, TMCLocation.DROPLETS_RIGHT_PATH_B1_2ND_CHEST, TMCRegion.DUNGEON_TOD_MAIN, Items.KINSTONE,
        (0x0E3B92, None), (0x2D8B, 0x04), 0x0A60),
    LocationData(
        6029393, TMCLocation.DROPLETS_RIGHT_PATH_B1_POT, TMCRegion.DUNGEON_TOD_MAIN, Items.KINSTONE,
        (0x0E3A73, 0x0E3A75), (0x2D8B, 0x02), 0x0A60, pools={POOL_POT}),
    LocationData(
        6029394, TMCLocation.DROPLETS_RIGHT_PATH_B3_FROZEN_CHEST, TMCRegion.DUNGEON_TOD_MAIN, Items.SMALL_KEY_TOD,
        (0x0E4426, None), (0x2D8D, 0x10), 0x1160),
    LocationData(
        6029395, TMCLocation.DROPLETS_RIGHT_PATH_B1_BLU_CHU_BIG_CHEST, TMCRegion.DUNGEON_TOD_MAIN, Items.LANTERN,
        (0x0E434E, None), (0x2D8C, 0x80), 0x1060),
    LocationData(
        6029396, TMCLocation.DROPLETS_RIGHT_PATH_B2_FROZEN_CHEST, TMCRegion.DUNGEON_TOD_MAIN, Items.RUPEES_100,
        (0x0E5A5A, None), (0x2D92, 0x40), 0x3260),
    LocationData(
        6029397, TMCLocation.DROPLETS_RIGHT_PATH_B2_DARK_MAZE_BOTTOM_CHEST, TMCRegion.DUNGEON_TOD_MAIN, Items.KINSTONE,
        (0x0E5216, None), (0x2D8F, 0x80), 0x2B60),
    LocationData(
        6029398, TMCLocation.DROPLETS_RIGHT_PATH_B2_MULLDOZERS_ITEM_DROP, TMCRegion.DUNGEON_TOD_MAIN, Items.SMALL_KEY_TOD,
        (0x0E55CB, None), (0x2D91, 0x80), 0x2F60),
    LocationData(
        6029399, TMCLocation.DROPLETS_RIGHT_PATH_B2_DARK_MAZE_TOP_RIGHT_CHEST, TMCRegion.DUNGEON_TOD_MAIN, Items.KINSTONE,
        (0x0E5206, None), (0x2D8F, 0x20), 0x2B60),
    LocationData(
        6029400, TMCLocation.DROPLETS_RIGHT_PATH_B2_DARK_MAZE_TOP_LEFT_CHEST, TMCRegion.DUNGEON_TOD_MAIN, Items.KINSTONE,
    ...
    LocationData(
        6029407, TMCLocation.DROPLETS_PRIZE, TMCRegion.DUNGEON_TOD_MAIN, Items.WATER_ELEMENT,

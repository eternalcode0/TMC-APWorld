...
all_locations: typing.List[LocationData] = [
    ...
    LocationData(
            6029018, TMCLocation.SOUTH_FIELD_FUSION_CHEST, TMCRegion.SOUTH_FIELD, None, (0x0FE0D6, None),
            (0x2CD3, 0x02),
            0x0103, ),
    LocationData(
    ...
    LocationData(
            6029023, TMCLocation.TOWN_SHOP_80_ITEM, TMCRegion.HYRULE_TOWN,
            TMCItem.BIG_WALLET, (0xFF0053, None), (0x2EA7, 0x01), 0x0023, scoutable=True, pools={POOL_SHOP}
    ),
    LocationData(
            6029024, TMCLocation.TOWN_SHOP_300_ITEM, TMCRegion.HYRULE_TOWN,
            TMCItem.PROGRESSIVE_BOOMERANG, (0xFF0073, None), (0x2EA7, 0x02), 0x0023, scoutable=True, pools={POOL_SHOP}
    ),
    LocationData(
            6029025, TMCLocation.TOWN_SHOP_600_ITEM, TMCRegion.HYRULE_TOWN,
            TMCItem.QUIVER, (0xFF0093, None), (0x2EA7, 0x04), 0x0023, scoutable=True, pools={POOL_SHOP}
    ),
    # LocationData(
    ...
    LocationData(
            6029027, TMCLocation.TOWN_SHOP_BEHIND_COUNTER_ITEM, TMCRegion.HYRULE_TOWN,
            TMCItem.DOG_FOOD, (0xFF00B3, None), (0x2CE6, 0x08), 0x0023, scoutable=True
    ),
    LocationData(
            6029028, TMCLocation.TOWN_SHOP_ATTIC_CHEST, TMCRegion.HYRULE_TOWN,
            None, (0x0D8EE6, None), (0x2D0A, 0x80), 0x012E
    ),
    LocationData(
            6029029, TMCLocation.TOWN_BAKERY_ATTIC_CHEST, TMCRegion.HYRULE_TOWN,
            TMCItem.RUPEES_100, (0x0D9206, None), (0x2D13, 0x20), 0x032E
    ),
    LocationData(
            6029030, TMCLocation.TOWN_INN_BACKDOOR_HP, TMCRegion.HYRULE_TOWN,
            TMCItem.HEART_PIECE, (0x0D66D7, None), (0x2CF3, 0x01), 0x0A21, pools={POOL_HP}
    ),
    LocationData(
            6029031, TMCLocation.TOWN_INN_LEDGE_CHEST, TMCRegion.HYRULE_TOWN,
            TMCItem.KINSTONE, (0x0EE35A, None), (0x2CD5, 0x01), 0x0002
    ),
    LocationData(
            6029032, TMCLocation.TOWN_INN_POT, TMCRegion.HYRULE_TOWN,
            TMCItem.KINSTONE, (0x0D663B, 0x0D663D), (0x2CE0, 0x80), 0x0921, pools={POOL_POT}
    ),
    LocationData(
            6029033, TMCLocation.TOWN_WELL_RIGHT_CHEST, TMCRegion.HYRULE_TOWN,
            TMCItem.KINSTONE, (0x0EFBDE, None), (0x2CFD, 0x01), 0x0041
    ),
    LocationData(

...
from .constants import DUNGEON_ABBR, DUNGEON_REGIONS, MinishCapItem, TMCItem, TMCLocation
...
DUNGEON_ITEMS = {
    "DWS": {"dungeon_big_keys": [TMCItem.BIG_KEY_DWS], "dungeon_small_keys": [TMCItem.SMALL_KEY_DWS] * 4,
            "dungeon_compasses": [TMCItem.DUNGEON_COMPASS_DWS], "dungeon_maps": [TMCItem.DUNGEON_MAP_DWS]},
    "CoF": {"dungeon_big_keys": [TMCItem.BIG_KEY_COF], "dungeon_small_keys": [TMCItem.SMALL_KEY_COF] * 2,
            "dungeon_compasses": [TMCItem.DUNGEON_COMPASS_COF], "dungeon_maps": [TMCItem.DUNGEON_MAP_COF]},
    "FoW": {"dungeon_big_keys": [TMCItem.BIG_KEY_FOW], "dungeon_small_keys": [TMCItem.SMALL_KEY_FOW] * 4,
            "dungeon_compasses": [TMCItem.DUNGEON_COMPASS_FOW], "dungeon_maps": [TMCItem.DUNGEON_MAP_FOW]},
    "ToD": {"dungeon_big_keys": [], "dungeon_small_keys": [TMCItem.SMALL_KEY_TOD] * 4,  # ToD big key is placed manually
            "dungeon_compasses": [TMCItem.DUNGEON_COMPASS_TOD], "dungeon_maps": [TMCItem.DUNGEON_MAP_TOD]},
    "RC": {"dungeon_big_keys": [], "dungeon_small_keys": [TMCItem.SMALL_KEY_RC] * 3, "dungeon_compasses": [],
           "dungeon_maps": []},
    "PoW": {"dungeon_big_keys": [TMCItem.BIG_KEY_POW], "dungeon_small_keys": [TMCItem.SMALL_KEY_POW] * 6,
            "dungeon_compasses": [TMCItem.DUNGEON_COMPASS_POW], "dungeon_maps": [TMCItem.DUNGEON_MAP_POW]},
    "DHC": {"dungeon_big_keys": [TMCItem.BIG_KEY_DHC], "dungeon_small_keys": [TMCItem.SMALL_KEY_DHC] * 5,
            "dungeon_compasses": [TMCItem.DUNGEON_COMPASS_DHC], "dungeon_maps": [TMCItem.DUNGEON_MAP_DHC]},
}
...
BANNED_KEY_LOCATIONS = frozenset({TMCLocation.DEEPWOOD_PRIZE, TMCLocation.DEEPWOOD_BOSS_ITEM,
...
def fill_dungeons(world: "MinishCapWorld"):
    ...
    elements = list(map(world.create_item, [TMCItem.EARTH_ELEMENT, TMCItem.FIRE_ELEMENT, TMCItem.WATER_ELEMENT,
                                            TMCItem.WIND_ELEMENT]))  # Order matters
    if world.options.shuffle_elements.value is ShuffleElements.option_dungeon_prize:
        ...
        fill_restrictive(multiworld, all_state, locations, elements, single_player_placement=True, lock=True,
...
def fill_dungeon(world: "MinishCapWorld", dungeon: str, items: list[MinishCapItem], all_state: CollectionState):
    ...
    world.random.shuffle(locations)
    # locations = [
    #     loc for region in world.get_regions() for loc in region.get_locations() if region in DUNGEON_REGIONS[dungeon]
    # ]
    fill_restrictive(multiworld, all_state, locations, items, single_player_placement=True, lock=True,
                     allow_excluded=True, name=f"TMC Dungeon Fill: {dungeon}")

...
def get_option_data(options: MinishCapOptions):
    ...
    return {
        ...
        "trick_mitts_farm_rupees": bool(ALL_TRICKS[0] in options.tricks),  # No, Yes
        "trick_bombable_dust": bool(ALL_TRICKS[1] in options.tricks),
        "trick_crenel_mushroom_gust_jar": bool(ALL_TRICKS[2] in options.tricks),
        "trick_light_arrows_break_objects": bool(ALL_TRICKS[3] in options.tricks),
        "trick_bobombs_destroy_walls": bool(ALL_TRICKS[4] in options.tricks),
        "trick_like_like_cave_no_sword": bool(ALL_TRICKS[5] in options.tricks),
        "trick_boots_skip_town_guard": bool(ALL_TRICKS[6] in options.tricks),
        "trick_beam_crenel_switch": bool(ALL_TRICKS[7] in options.tricks),
        "trick_down_thrust_spikey_beetle": bool(ALL_TRICKS[8] in options.tricks),
        "trick_dark_rooms_no_lantern": bool(ALL_TRICKS[9] in options.tricks),
        "trick_cape_extensions": bool(ALL_TRICKS[10] in options.tricks),
        "trick_lake_minish_no_boots": bool(ALL_TRICKS[11] in options.tricks),
        "trick_cabin_swim_no_lilypad": bool(ALL_TRICKS[12] in options.tricks),
        "trick_cloud_sharks_no_weapons": bool(ALL_TRICKS[13] in options.tricks),
        "trick_pow_2f_no_cane": bool(ALL_TRICKS[14] in options.tricks),
        "trick_pot_puzzle_no_bracelets": bool(ALL_TRICKS[15] in options.tricks),
        "trick_fow_pot_gust_jar": bool(ALL_TRICKS[16] in options.tricks),
        "trick_dhc_cannons_no_four_sword": bool(ALL_TRICKS[17] in options.tricks),
        "trick_dhc_pads_no_four_sword": bool(ALL_TRICKS[18] in options.tricks),
        "trick_dhc_switches_no_four_sword": bool(ALL_TRICKS[19] in options.tricks),
    }

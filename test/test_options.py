...
class TestWindCrests(MinishCapTestBase):
    ...
    default_access_list = [
        [
            ...
            [TMCItem.ROCS_CAPE, TMCItem.GRIP_RING, TMCItem.BOTTLE, TMCItem.PROGRESSIVE_SWORD, TMCItem.FAST_SPIN_SCROLL],
    ...
    location_list = [
        ...
        TMCLocation.WIND_TRIBE_3F_LEFT_CHEST,  # TODO Fusion
        TMCLocation.LON_LON_PUDDLE_FUSION_BIG_CHEST,  # TODO Fusion
        TMCLocation.SWAMP_BUTTERFLY_FUSION_ITEM,  # TODO Fusion
        TMCLocation.SOUTH_FIELD_FUSION_CHEST,  # TODO Fusion

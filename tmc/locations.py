...
DEFAULT_SET = frozenset({POOL_HP, POOL_SCROLL, POOL_FAIRY, POOL_SCRUB, POOL_BUTTERFLY, POOL_ELEMENT, POOL_SHOP})


def get_location_map(
    world: MinishCapWorld, location_names: list[TMCLocation] | None = None
) -> dict[TMCLocation, Location]:
    if location_names is None or len(location_names) == 0:
        location_names = list(TMCLocation)
...
all_locations: list[LocationData] = [
    ...
    LocationData(
        6029002,
        TMCLocation.SMITH_HOUSE_SHIELD,
        TMCRegion.SOUTH_FIELD,
    ...
    LocationData(
        6029022,
        TMCLocation.TOWN_CAFE_LADY_NPC,
    ...
    LocationData(
        6029065,
        TMCLocation.TOWN_WATERFALL_FUSION_CHEST,
        TMCRegion.HYRULE_TOWN,
        None,
        (0x0F8082, None),
        (0x2D1D, 0x40),
    ...
    LocationData(
        6029096,
        TMCLocation.NORTH_FIELD_TREE_FUSION_TOP_LEFT_CHEST,
        TMCRegion.NORTH_FIELD,
        TMCItem.KINSTONE,
        (0x0F7BE6, None),
        (0x2D1C, 0x10),
    ...
    LocationData(
        6029097,
        TMCLocation.NORTH_FIELD_TREE_FUSION_TOP_RIGHT_CHEST,
        TMCRegion.NORTH_FIELD,
        TMCItem.KINSTONE,
        (0x0F7BEE, None),
        (0x2D1C, 0x20),
    ...
    LocationData(
        6029098,
        TMCLocation.NORTH_FIELD_TREE_FUSION_BOTTOM_LEFT_CHEST,
        TMCRegion.NORTH_FIELD,
        TMCItem.KINSTONE,
        (0x0F7BF6, None),
        (0x2D1C, 0x40),
    ...
    LocationData(
        6029099,
        TMCLocation.NORTH_FIELD_TREE_FUSION_BOTTOM_RIGHT_CHEST,
        TMCRegion.NORTH_FIELD,
        None,
        (0x0F7BFE, None),
        (0x2D1C, 0x80),
    ...
    LocationData(
        6029100,
        TMCLocation.NORTH_FIELD_TREE_FUSION_CENTER_BIG_CHEST,
        TMCRegion.NORTH_FIELD,
        TMCItem.PROGRESSIVE_BOOMERANG,
        (0x0F7C06, None),
        (0x2D1D, 0x01),
    ...
    LocationData(
        6029104,
        TMCLocation.CASTLE_GOLDEN_ROPE,
        TMCRegion.CASTLE_EXTERIOR,
        TMCItem.RUPEES_100,
        (0xFF013A, None),
        (0x2CA2, 0x20),
    ...
    LocationData(
        6029105,
        TMCLocation.CASTLE_RIGHT_FOUNTAIN_FUSION_HP,
        TMCRegion.CASTLE_EXTERIOR,
        TMCItem.HEART_PIECE,
        (0x0D9C2B, None),
        (0x2D0E, 0x10),
    ...
    LocationData(
        6029108,
        TMCLocation.CASTLE_RIGHT_FOUNTAIN_FUSION_MINISH_HOLE_CHEST,
        TMCRegion.CASTLE_EXTERIOR,
        None,
        (0x0DBD3E, None),
        (0x2D28, 0x10),
    ...
    LocationData(
        6029109,
        TMCLocation.CASTLE_LEFT_FOUNTAIN_FUSION_MINISH_HOLE_CHEST,
        TMCRegion.CASTLE_EXTERIOR,
        None,
        (0x0DBD8E, None),
        (0x2D28, 0x20),
    ...
    LocationData(
        6029110,
        TMCLocation.PEDESTAL_REQUIREMENT_REWARD,
        TMCRegion.SANCTUARY,
        None,
        (0xFF002C, None),
        (0x2C9E, 0x40),
    ...
    LocationData(
        6029130,
        TMCLocation.FALLS_LOWER_LON_LON_FUSION_CHEST,
    ...
    LocationData(
        6029132,
        TMCLocation.FALLS_LOWER_WATERFALL_FUSION_DOJO_NPC,
        TMCRegion.LOWER_FALLS,
    ...
    LocationData(
        6029167,
        TMCLocation.MINISH_WOODS_WEST_FUSION_CHEST,
        TMCRegion.MINISH_WOODS,
        TMCItem.RUPEES_200,
        (0x0FE0CE, None),
        (0x2CD3, 0x01),
    ...
    LocationData(
        6029170,
        TMCLocation.MINISH_WOODS_EAST_FUSION_CHEST,
        TMCRegion.MINISH_WOODS,
        TMCItem.KINSTONE,
        (0x0FE0B6, None),
        (0x2CD2, 0x20),
    ...
    LocationData(
        6029171,
        TMCLocation.MINISH_WOODS_SOUTH_FUSION_CHEST,
        TMCRegion.MINISH_WOODS,
        TMCItem.KINSTONE,
        (0x0FE0C6, None),
        (0x2CD2, 0x80),
    ...
    LocationData(
        6029172,
        TMCLocation.MINISH_WOODS_BOTTOM_HP,
        TMCRegion.MINISH_WOODS,
        TMCItem.HEART_PIECE,
        (0x0F4357, None),
        (0x2CC3, 0x10),
    ...
    LocationData(
        6029173,
        TMCLocation.MINISH_WOODS_CRACK_FUSION_CHEST,
        TMCRegion.MINISH_WOODS,
        TMCItem.KINSTONE,
        (0x0DC42A, None),
        (0x2CF0, 0x08),
    ...
    LocationData(
        6029174,
        TMCLocation.MINISH_WOODS_MINISH_PATH_FUSION_CHEST,
        TMCRegion.MINISH_WOODS,
        TMCItem.RUPEES_200,
        (0x0FE08E, None),
        (0x2D11, 0x04),
    ...
    LocationData(
        6029175,
        TMCLocation.MINISH_VILLAGE_BARREL_HOUSE_ITEM,
        TMCRegion.MINISH_WOODS,
        TMCItem.JABBER_NUT,
        (0x0DA283, None),
        (0x2CF5, 0x04),
    ...
    LocationData(
        6029179,
        TMCLocation.MINISH_WOODS_BOMB_MINISH_NPC_2,
        TMCRegion.BELARI,
        TMCItem.REMOTE_BOMB,
        (0x00A0A0, None),
        (0x2CF2, 0x01),
    ...
    LocationData(
        6029185,
        TMCLocation.TRILBY_MIDDLE_FUSION_CHEST,
    ...
    LocationData(
        6029186,
        TMCLocation.TRILBY_TOP_FUSION_CHEST,
        TMCRegion.TRILBY_HIGHLANDS,
        TMCItem.KINSTONE,
        (0x0FE0BE, None),
        (0x2CD2, 0x40),
    ...
    LocationData(
        6029189,
        TMCLocation.TRILBY_DIG_CAVE_WATER_FUSION_CHEST,
        TMCRegion.TRILBY_HIGHLANDS,
        TMCItem.KINSTONE,
        (0x0F3D8E, None),
        (0x2D05, 0x01),
    ...
    LocationData(
        6029192,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM1,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F83BB, None),
        (0x2D20, 0x10),
    ...
    LocationData(
        6029193,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM2,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F83CB, None),
        (0x2D20, 0x20),
    ...
    LocationData(
        6029194,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM3,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F83DB, None),
        (0x2D20, 0x40),
    ...
    LocationData(
        6029195,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM4,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F83EB, None),
        (0x2D20, 0x80),
    ...
    LocationData(
        6029196,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM5,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F83FB, None),
        (0x2D21, 0x01),
    ...
    LocationData(
        6029197,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM6,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F840B, None),
        (0x2D21, 0x02),
    ...
    LocationData(
        6029198,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM7,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F841B, None),
        (0x2D21, 0x04),
    ...
    LocationData(
        6029199,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM8,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F842B, None),
        (0x2D21, 0x08),
    ...
    LocationData(
        6029200,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM9,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F843B, None),
        (0x2D21, 0x10),
    ...
    LocationData(
        6029201,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM10,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F844B, None),
        (0x2D21, 0x20),
    ...
    LocationData(
        6029202,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM11,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F845B, None),
        (0x2D21, 0x40),
    ...
    LocationData(
        6029203,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM12,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F846B, None),
        (0x2D21, 0x80),
    ...
    LocationData(
        6029204,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM13,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F847B, None),
        (0x2D22, 0x01),
    ...
    LocationData(
        6029205,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM14,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F848B, None),
        (0x2D22, 0x02),
    ...
    LocationData(
        6029206,
        TMCLocation.TRILBY_PUDDLE_FUSION_ITEM15,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_5,
        (0x0F849B, None),
        (0x2D22, 0x04),
    ...
    LocationData(
        6029207,
        TMCLocation.WESTERN_WOODS_FUSION_CHEST,
        TMCRegion.WESTERN_WOODS,
        None,
        (0x0F7976, None),
        (0x2CCF, 0x10),
    ...
    LocationData(
        6029208,
        TMCLocation.WESTERN_WOODS_TREE_FUSION_HP,
        TMCRegion.WESTERN_WOODS,
        TMCItem.HEART_PIECE,
        (0x0F9E1F, None),
        (0x2CEF, 0x01),
    ...
    LocationData(
        6029220,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_CHEST,
        TMCRegion.WESTERN_WOODS,
        TMCItem.KINSTONE,
        (0x0F62C2, None),
        (0x2D0D, 0x08),
    ...
    LocationData(
        6029221,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM1,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F6143, None),
        (0x2D0D, 0x10),
    ...
    LocationData(
        6029222,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM2,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F6153, None),
        (0x2D0D, 0x20),
    ...
    LocationData(
        6029223,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM3,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F6163, None),
        (0x2D0D, 0x40),
    ...
    LocationData(
        6029224,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM4,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F6173, None),
        (0x2D0D, 0x80),
    ...
    LocationData(
        6029225,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM5,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F6183, None),
        (0x2D0E, 0x01),
    ...
    LocationData(
        6029226,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM6,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F6193, None),
        (0x2D0E, 0x02),
    ...
    LocationData(
        6029227,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM7,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F61A3, None),
        (0x2D0E, 0x04),
    ...
    LocationData(
        6029228,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM8,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F61B3, None),
        (0x2D0E, 0x08),
    ...
    LocationData(
        6029229,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM9,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F61C3, None),
        (0x2D0F, 0x40),
    ...
    LocationData(
        6029230,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM10,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F61D3, None),
        (0x2D0F, 0x80),
    ...
    LocationData(
        6029231,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM11,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F61E3, None),
        (0x2D10, 0x01),
    ...
    LocationData(
        6029232,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM12,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F61F3, None),
        (0x2D10, 0x02),
    ...
    LocationData(
        6029233,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM13,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F6203, None),
        (0x2D10, 0x04),
    ...
    LocationData(
        6029234,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM14,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F6213, None),
        (0x2D10, 0x08),
    ...
    LocationData(
        6029235,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM15,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F6223, None),
        (0x2D10, 0x10),
    ...
    LocationData(
        6029236,
        TMCLocation.WESTERN_WOODS_BEANSTALK_FUSION_ITEM16,
        TMCRegion.WESTERN_WOODS,
        TMCItem.RUPEES_20,
        (0x0F6233, None),
        (0x2D10, 0x20),
    ...
    LocationData(
        6029237,
        TMCLocation.CRENEL_BASE_ENTRANCE_VINE,
        TMCRegion.TRILBY_HIGHLANDS,
        TMCItem.RUPEES_20,
        (0x0FAACF, None),
        (0x2CC5, 0x02),
    ...
    LocationData(
        6029241,
        TMCLocation.CRENEL_BASE_GREEN_WATER_FUSION_CHEST,
        TMCRegion.CRENEL_BASE,
        TMCItem.KINSTONE,
        (0x0FE06E, None),
        (0x2D10, 0x80),
    ...
    LocationData(
        6029242,
        TMCLocation.CRENEL_BASE_WEST_FUSION_CHEST,
        TMCRegion.CRENEL_BASE,
        TMCItem.RUPEES_200,
        (0x0FE116, None),
        (0x2CD4, 0x02),
    ...
    LocationData(
        6029248,
        TMCLocation.CRENEL_VINE_TOP_GOLDEN_TEKTITE,
        TMCRegion.CRENEL,
        TMCItem.RUPEES_100,
        (0xFF0128, None),
        (0x2CA2, 0x04),
    ...
    LocationData(
        6029251,
        TMCLocation.CRENEL_BELOW_COF_GOLDEN_TEKTITE,
        TMCRegion.CRENEL,
        TMCItem.RUPEES_100,
        (0xFF0146, None),
        (0x2CA2, 0x80),
    ...
    LocationData(
        6029258,
        TMCLocation.CRENEL_CLIMB_FUSION_CHEST,
        TMCRegion.CRENEL,
        TMCItem.KINSTONE,
        (0x0FE10E, None),
        (0x2CD4, 0x01),
    ...
    LocationData(
        6029260,
        TMCLocation.CRENEL_BEANSTALK_FUSION_HP,
        TMCRegion.CRENEL,
        TMCItem.HEART_PIECE,
        (0x0F5D9B, None),
        (0x2D0C, 0x08),
    ...
    LocationData(
        6029261,
        TMCLocation.CRENEL_BEANSTALK_FUSION_ITEM1,
        TMCRegion.CRENEL,
        TMCItem.RUPEES_20,
        (0x0F5DAB, None),
        (0x2D0E, 0x40),
    ...
    LocationData(
        6029262,
        TMCLocation.CRENEL_BEANSTALK_FUSION_ITEM2,
        TMCRegion.CRENEL,
        TMCItem.RUPEES_20,
        (0x0F5DBB, None),
        (0x2D0E, 0x80),
    ...
    LocationData(
        6029263,
        TMCLocation.CRENEL_BEANSTALK_FUSION_ITEM3,
        TMCRegion.CRENEL,
        TMCItem.RUPEES_20,
        (0x0F5DCB, None),
        (0x2D0F, 0x01),
    ...
    LocationData(
        6029264,
        TMCLocation.CRENEL_BEANSTALK_FUSION_ITEM4,
        TMCRegion.CRENEL,
        TMCItem.RUPEES_20,
        (0x0F5DDB, None),
        (0x2D0F, 0x02),
    ...
    LocationData(
        6029265,
        TMCLocation.CRENEL_BEANSTALK_FUSION_ITEM5,
        TMCRegion.CRENEL,
        TMCItem.RUPEES_20,
        (0x0F5DEB, None),
        (0x2D0F, 0x04),
    ...
    LocationData(
        6029266,
        TMCLocation.CRENEL_BEANSTALK_FUSION_ITEM6,
        TMCRegion.CRENEL,
        TMCItem.RUPEES_20,
        (0x0F5DFB, None),
        (0x2D0F, 0x08),
    ...
    LocationData(
        6029267,
        TMCLocation.CRENEL_BEANSTALK_FUSION_ITEM7,
        TMCRegion.CRENEL,
        TMCItem.RUPEES_20,
        (0x0F5E0B, None),
        (0x2D0F, 0x10),
    ...
    LocationData(
        6029268,
        TMCLocation.CRENEL_BEANSTALK_FUSION_ITEM8,
        TMCRegion.CRENEL,
        TMCItem.RUPEES_20,
        (0x0F5E1B, None),
        (0x2D0F, 0x20),
    ...
    LocationData(
        6029269,
        TMCLocation.CRENEL_RAIN_PATH_FUSION_CHEST,
        TMCRegion.CRENEL,
        TMCItem.KINSTONE,
        (0x0FE066, None),
        (0x2D10, 0x40),
    ...
    LocationData(
        6029271,
        TMCLocation.CRENEL_MINES_PATH_FUSION_CHEST,
        TMCRegion.MELARI,
        None,
        (0x0FE096, None),
        (0x2D11, 0x08),
    ...
    LocationData(
        6029281,
        TMCLocation.SWAMP_BUTTERFLY_FUSION_ITEM,
        TMCRegion.CASTOR_WILDS,
        TMCItem.DIG_BUTTERFLY,
        (0x0FE13F, None),
        (0x2EA7, 0x10),
        0x0004,
        pools={POOL_BUTTERFLY},
    ),
    LocationData(
        6029282,
    ...
    LocationData(
        6029286,
        TMCLocation.SWAMP_WATERFALL_FUSION_DOJO_NPC,
        TMCRegion.CASTOR_WILDS,
    ...
    LocationData(
        6029296,
        TMCLocation.SWAMP_MINISH_FUSION_NORTH_CRACK_CHEST,
        TMCRegion.CASTOR_WILDS,
        TMCItem.KINSTONE,
        (0x0DC49A, None),
        (0x2CDE, 0x08),
    ...
    LocationData(
        6029298,
        TMCLocation.SWAMP_MINISH_FUSION_NORTH_WEST_CRACK_CHEST,
        TMCRegion.CASTOR_WILDS,
        TMCItem.KINSTONE,
        (0x0DC67A, None),
        (0x2CF0, 0x20),
    ...
    LocationData(
        6029299,
        TMCLocation.SWAMP_MINISH_FUSION_WEST_CRACK_CHEST,
        TMCRegion.CASTOR_WILDS,
        TMCItem.KINSTONE,
        (0x0DC512, None),
        (0x2CDE, 0x10),
    ...
    LocationData(
        6029300,
        TMCLocation.SWAMP_MINISH_FUSION_VINE_CRACK_CHEST,
        TMCRegion.CASTOR_WILDS,
        TMCItem.KINSTONE,
        (0x0DC58A, None),
        (0x2CDE, 0x20),
    ...
    LocationData(
        6029301,
        TMCLocation.SWAMP_MINISH_FUSION_WATER_HOLE_CHEST,
        TMCRegion.CASTOR_WILDS,
        TMCItem.KINSTONE,
        (0x0DB3C6, None),
        (0x2D2C, 0x20),
    ...
    LocationData(
        6029302,
        TMCLocation.SWAMP_MINISH_FUSION_WATER_HOLE_HP,
        TMCRegion.CASTOR_WILDS,
        TMCItem.HEART_PIECE,
        (0x0DB3F7, None),
        (0x2D2C, 0x10),
    ...
    LocationData(
        6029303,
        TMCLocation.RUINS_BUTTERFLY_FUSION_ITEM,
    ...
    LocationData(
        6029305,
        TMCLocation.RUINS_MINISH_HOME_CHEST,
        TMCRegion.WIND_RUINS,
        TMCItem.KINSTONE,
        (0x0DC3BA, None),
        (0x2CDE, 0x04),
    ...
    LocationData(
        6029306,
        TMCLocation.RUINS_PILLARS_FUSION_CHEST,
        TMCRegion.WIND_RUINS,
        None,
        (0x0FE11E, None),
        (0x2CD4, 0x04),
    ...
    LocationData(
        6029307,
        TMCLocation.RUINS_BEAN_STALK_FUSION_BIG_CHEST,
        TMCRegion.WIND_RUINS,
        TMCItem.QUIVER,
        (0x0F603A, None),
        (0x2D0C, 0x80),
    ...
    LocationData(
        6029308,
        TMCLocation.RUINS_CRACK_FUSION_CHEST,
        TMCRegion.WIND_RUINS,
        TMCItem.KINSTONE,
        (0x0DC602, None),
        (0x2CF0, 0x10),
    ...
    LocationData(
        6029313,
        TMCLocation.RUINS_NEAR_FOW_FUSION_CHEST,
        TMCRegion.WIND_RUINS,
        TMCItem.BOMB_BAG,
        (0x0FE0AE, None),
        (0x2CD2, 0x10),
    ...
    LocationData(
        6029315,
        TMCLocation.VALLEY_PRE_VALLEY_FUSION_CHEST,
    ...
    LocationData(
        6029319,
        TMCLocation.VALLEY_GRAVEYARD_BUTTERFLY_FUSION_ITEM,
        TMCRegion.GRAVEYARD,
    ...
    LocationData(
        6029320,
        TMCLocation.VALLEY_GRAVEYARD_LEFT_FUSION_CHEST,
        TMCRegion.GRAVEYARD,
        TMCItem.KINSTONE,
        (0x0FE0DE, None),
        (0x2CD3, 0x04),
    ...
    LocationData(
        6029322,
        TMCLocation.VALLEY_GRAVEYARD_RIGHT_FUSION_CHEST,
        TMCRegion.GRAVEYARD,
        TMCItem.KINSTONE,
        (0x0FE0E6, None),
        (0x2CD3, 0x08),
    ...
    LocationData(
        6029323,
        TMCLocation.VALLEY_GRAVEYARD_RIGHT_GRAVE_FUSION_CHEST,
        TMCRegion.GRAVEYARD,
        None,
        (0x0D8B6E, None),
        (0x2D27, 0x40),
    ...
    LocationData(
        6029331,
        TMCLocation.FALLS_WATER_DIG_CAVE_FUSION_HP,
        TMCRegion.FALLS_ENTRANCE,
        TMCItem.HEART_PIECE,
        (0x0F3DD7, None),
        (0x2D05, 0x20),
    ...
    LocationData(
        6029332,
        TMCLocation.FALLS_WATER_DIG_CAVE_FUSION_CHEST,
        TMCRegion.FALLS_ENTRANCE,
        None,
        (0x0F3E26, None),
        (0x2D05, 0x04),
    ...
    LocationData(
        6029333,
        TMCLocation.FALLS_1ST_CAVE_CHEST,
    ...
    LocationData(
        6029334, TMCLocation.FALLS_CLIFF_CHEST, TMCRegion.MIDDLE_FALLS, None, (0x0F89C2, None), (0x2CD0, 0x02), 0x000A
    ),
    LocationData(
        6029335,
    ...
    LocationData(
        6029336,
        TMCLocation.FALLS_GOLDEN_TEKTITE,
    ...
    LocationData(
        6029338,
        TMCLocation.FALLS_ROCK_FUSION_CHEST,
        TMCRegion.UPPER_FALLS,
        TMCItem.KINSTONE,
        (0x0FE106, None),
        (0x2CD3, 0x80),
    ...
    LocationData(
        6029365, TMCLocation.CLOUDS_SOUTH_LEFT_CHEST, TMCRegion.CLOUDS, None, (0x0DCE32, None), (0x2CD8, 0x01), 0x0108
    ),
    LocationData(
        6029366,
    ...
    LocationData(
        6029370, TMCLocation.CLOUDS_SOUTH_RIGHT_CHEST, TMCRegion.CLOUDS, None, (0x0DCE3A, None), (0x2CD8, 0x02), 0x0108
    ),
    LocationData(
        6029371,
    ...
    LocationData(
        6029374,
        TMCLocation.WIND_TRIBE_1F_LEFT_CHEST,
        TMCRegion.SOUTH_FIELD,
        TMCItem.KINSTONE,
        (0x0F582A, None),
        (0x2CDC, 0x20),
    ...
    LocationData(
        6029375,
        TMCLocation.WIND_TRIBE_1F_RIGHT_CHEST,
        TMCRegion.SOUTH_FIELD,
        TMCItem.KINSTONE,
        (0x0F5832, None),
        (0x2CDC, 0x40),
    ...
    LocationData(
        6029376,
        TMCLocation.WIND_TRIBE_2F_CHEST,
        TMCRegion.SOUTH_FIELD,
        TMCItem.KINSTONE,
        (0x0F5972, None),
        (0x2CDC, 0x80),
    ...
    LocationData(
        6029379,
        TMCLocation.WIND_TRIBE_3F_LEFT_CHEST,
        TMCRegion.WIND_TRIBE,
        TMCItem.KINSTONE,
        (0x0F5A92, None),
        (0x2CDD, 0x04),
    ...
    LocationData(
        6029380,
        TMCLocation.WIND_TRIBE_3F_CENTER_CHEST,
        TMCRegion.WIND_TRIBE,
        TMCItem.KINSTONE,
        (0x0F5A8A, None),
        (0x2CDD, 0x02),
    ...
    LocationData(
        6029381,
        TMCLocation.WIND_TRIBE_3F_RIGHT_CHEST,
        TMCRegion.WIND_TRIBE,
        TMCItem.KINSTONE,
        (0x0F5A82, None),
        (0x2CDD, 0x01),
    ...
    LocationData(
        6029382,
        TMCLocation.WIND_TRIBE_4F_LEFT_CHEST,
        TMCRegion.WIND_TRIBE,
        TMCItem.KINSTONE,
        (0x0F5BD2, None),
        (0x2CDD, 0x40),
    ...
    LocationData(
        6029383,
        TMCLocation.WIND_TRIBE_4F_RIGHT_CHEST,
        TMCRegion.WIND_TRIBE,
        TMCItem.KINSTONE,
        (0x0F5BDA, None),
        (0x2CDD, 0x80),
    ...
    LocationData(
        6029386,
        TMCLocation.DEEPWOOD_1F_SLUG_TORCHES_CHEST,
        TMCRegion.DUNGEON_DWS_ENTRANCE,
    ...
    LocationData(
        6029402,
        TMCLocation.COF_1F_SPIKE_BEETLE_BIG_CHEST,
    ...
    LocationData(
        ...
        ([0x0E2B0B, 0x0FC46B, 0x0FC48B], [None, None, None]),
        (0x2D73, 0x80),
        0x2058,
    ),
    LocationData(
    ...
    LocationData(
        6029460,
        TMCLocation.FORTRESS_RIGHT_2F_LEFT_CHEST,
        TMCRegion.DUNGEON_FOW_ENTRANCE,
        TMCItem.KINSTONE,
        (0x0E2ABA, None),
        (0x2D73, 0x20),
    ...
    LocationData(
        6029461,
        TMCLocation.FORTRESS_RIGHT_2F_RIGHT_CHEST,
        TMCRegion.DUNGEON_FOW_ENTRANCE,
        TMCItem.KINSTONE,
        (0x0E2AC2, None),
        (0x2D73, 0x40),
    ...
    LocationData(
        6029464,
        TMCLocation.FORTRESS_RIGHT_3F_ITEM_DROP,
        TMCRegion.DUNGEON_FOW_ENTRANCE,
        TMCItem.SMALL_KEY_FOW,
        ([0x0E2C4B, 0x0FC4AB, 0x0FC4CB], [None, None, None]),
        (0x2D74, 0x02),
        0x2258,
    ),
    LocationData(
        6029465,
        TMCLocation.FORTRESS_ENTRANCE_1F_RIGHT_HP,
        TMCRegion.DUNGEON_FOW_ENTRANCE,
        TMCItem.HEART_PIECE,
        (0x0E2DD7, None),
        (0x2D74, 0x80),
    ...
    LocationData(
        6029634,
        TMCLocation.FUSION_22,
        TMCRegion.FUSIONS,
        TMCLocation.FUSION_22,
        None,
        None,
        None,
        pools={POOL_BLUE_FUSE},
    ),
    LocationData(
        6029635,
        TMCLocation.FUSION_23,
        TMCRegion.FUSIONS,
        TMCLocation.FUSION_23,
        None,
        None,
    ...
    LocationData(
        6029652,
        TMCLocation.FUSION_34,
        TMCRegion.FUSIONS,
        TMCLocation.FUSION_34,
        None,
        None,
        None,
        pools={POOL_GREEN_FUSE},
    ),
    LocationData(
        6029653,
        TMCLocation.FUSION_35,
        TMCRegion.FUSIONS,
        TMCLocation.FUSION_35,
        None,
        None,

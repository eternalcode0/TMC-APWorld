...
def pool_traps() -> [ItemData]:
    return [TRAP_ICE, TRAP_FIRE, TRAP_ZAP, TRAP_BOMB, TRAP_MONEY, TRAP_STINK, TRAP_ROPE, TRAP_BAT, TRAP_LIKE,
            TRAP_CURSE]
...
item_list: list[ItemData] = [
    ...
    *(pool_kinstone_gold()), *(pool_traps()),
    # *(pool_kinstone_red()), *(pool_kinstone_blue()), *(pool_kinstone_green()),
]

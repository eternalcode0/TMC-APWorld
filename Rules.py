...
class MinishCapRules():
    ...
    def __init__(self, world: "MinishCapWorld") -> None:
        ...
        self.location_rules = {
            ...
            #TMCLocation.TOWN_SHOP_EXTRA_600_ITEM:
            #    self.has(TMCItem.BIG_WALLET, 3),
            ...
            #TMCLocation.TOD_ENTRANCE:  # Entrance Rando
            #    self.has(TMCItem.FLIPPERS),
            ...
            TMCLocation.CRENEL_MELARI_LEFT_DIG:
                self.has(TMCItem.MOLE_MITTS),
            ...
            TMCLocation.RUINS_NEAR_FOW_FUSION_CHEST: # Fusion 0A
                self.has(TMCItem.PROGRESSIVE_SWORD),
            # TMCLocation.FOW_ENTRANCE: # Entrance Rando
            #     self.has(TMCItem.PROGRESSIVE_SWORD),
            #endregion
            ...
            #     self.logic_and([
            #         self.has(TMCItem.GRIP_RING),
            #         self.has(TMCItem.PROGRESSIVE_SHIELD,2)
            #     ])
            #endregion
            ...
            TMCLocation.FORTRESS_LEFT_2F_DIG_CHEST:
                self.has_all([
                    TMCItem.MOLE_MITTS,
                    TMCItem.PROGRESSIVE_BOW,
                    TMCItem.PROGRESSIVE_SWORD   # Damage
                ]),
            ...
            TMCLocation.FORTRESS_LEFT_2F_ITEM5:
                self.has_all([TMCItem.PROGRESSIVE_BOW, TMCItem.PROGRESSIVE_SWORD]), # This one can get grabbed through the wall
